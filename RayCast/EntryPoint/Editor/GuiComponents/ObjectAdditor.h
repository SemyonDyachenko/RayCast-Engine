...
public:
	...
	static Mesh* CreateMesh(DefaultObjects object);
	...
	void AddEntity(std::string meshPath,std::string name,EditorScene& target,GuiConsole & console,glm::vec3 position = glm::vec3(0,0,0));
